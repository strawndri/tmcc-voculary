...
urlpatterns = [
    ...
    path('alterar_nome/<int:texto_id>/', views.alterar_nome_texto_view, name='alterar_nome_texto'),
    path('desativar-texto/<int:texto_id>/', views.desativar_texto_view, name="desativar_texto"),
]